 ...
 */
export function RequestItem({ request, onClick, isSelected = false }: RequestItemProps) {
  return (
    <div
      onClick={onClick}
      className={`px-4 py-3 border-b border-[var(--border)] hover:bg-[var(--surface)] cursor-pointer transition-colors ${
