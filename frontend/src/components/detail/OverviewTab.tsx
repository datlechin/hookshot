...
export function OverviewTab({ request }: OverviewTabProps) {
  ...
  return (
    <div className="p-4 space-y-6">
      {/* Request Line */}
      <div>
        <h3 className="text-sm font-semibold text-(--text-secondary) mb-2">Request</h3>
        ...
        {request.query_string && (
          <div className="mt-2">
            <span className="text-xs text-(--text-secondary)">Query String:</span>
            <code className="ml-2 text-xs font-mono text-(--text-primary)">
              {request.query_string}
            </code>
          </div>
        )}
      ...
      <div className="grid grid-cols-1 gap-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2">
              <div className="text-sm font-mono text-(--text-primary)">{request.ip_address}</div>
              <CopyButton
                text={request.ip_address}
                label=""
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <div className="text-xs text-(--text-secondary) mb-1">Content Type</div>
            <div className="flex items-center gap-2">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="text-sm text-(--text-primary)">{formatBytes(totalSize)}</div>
          </div>
        </div>
      </div>
      ...
      {/* Body Preview */}
      <div>
        <h3 className="text-sm font-semibold text-(--text-secondary) mb-2">Body Preview</h3>
